...
public class JarHelper {
    ...
    public static void invoke(String fileName, String[] param){
        Process process=null;
        StringBuffer commandLine=new StringBuffer();
        commandLine.append(ConfigUtil.getString("jar_exec_command_line"));
        commandLine.append(ConfigUtil.getString("sftp_local_save_path"));
...
//            process.getOutputStream();
    ...
    public static void invoke(String fileName, Map<String,Object> params){
        Process process=null;
        StringBuffer commandLine=new StringBuffer();
        commandLine.append(ConfigUtil.getString("jar_exec_command_line"));
        commandLine.append(ConfigUtil.getString("sftp_local_save_path"));
...
//            log.info(s+":"+params.get(s).toString());
            commandLine.append(" " + params.get(s).toString());
        }
