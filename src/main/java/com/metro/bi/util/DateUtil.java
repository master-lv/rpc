...
public class DateUtil {
     ...
     * @return 格式化后的字符串
     */
    public static String parseDateToStr(String timeFromat) {
     ...
     * @return useFlag
     */
    public static int getDeliveryTimeFlag() {
    ...
    public static long dateDiffe(String beginDate,String  endDate){
        SimpleDateFormat dfs = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            Date begin=dfs.parse(beginDate);//"2004-01-02 11:30:24"
            Date end = dfs.parse(endDate);//"2004-03-26 13:31:40"
    ...
    public static long dateBetween1970(String beginDate){
        SimpleDateFormat dfs = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            Date begin=dfs.parse(beginDate);//"2004-01-02 11:30:24"
            return (new Date().getTime()-begin.getTime())/1000;
        } catch (ParseException e) {
            e.printStackTrace();
            return 0;
        }
