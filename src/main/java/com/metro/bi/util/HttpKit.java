...
//        char[] keyStorePassword = ConfigUtil.getString("wx.mchid").toCharArray(); //证书密码
        try {
...
//            keyManagerFactory.init(keystore, keyStorePassword);
     ...
     * @return 请求失败返回null
     */
    public static String posts(String url, String requestBody) {
        AsyncHttpClient http = new AsyncHttpClient(
                new AsyncHttpClientConfig.Builder()
                        .setConnectTimeout(CONNECT_TIME_OUT)
    ...
    public static void main(String[] ar){
        ...
        obj.put("type","1");
        obj.put("algorithmName","Encrypt");
        obj.put("methodName","test");
        obj.put("params","{\"key\":\"value\",\"code\":\"name\"}");
        post("http://123.59.204.138:8080/rpc/invoke/innerCheck",obj);
    }
}
